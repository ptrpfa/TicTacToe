...
from tic import print_board, weight_update, finished
# initial weights is all 1.0
...
# training phase pits two computer player against each other
for i in range(10000):
    ...
    while (True):
        ...
        if i % 2 == 0:
            ...
            if outcome[0] != -1:
                break # stop training once a draw or win is detected
